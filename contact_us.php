...
<style>
#get-in-touch .image-wrap {background-image: url('../images/worship_blurred.jpg');
}
</style>            
              <div class="image-spacing text-bg narrowside floatright">
                        ...
                        <h4>Your Chance to Connect.</h4>
                        <p>How can we serve you and your family? Whether you have a need or you’re simply looking for more information, we would love to celebrate with you, pray with you and help you plug in to an authentic community that cares.</p>
                        </div>
...
<form class="formoid-metro-orange" action="http://www.praisechurch.tv/forms/ineedprayer_files/ineedprayer.php" method="post" accept-charset="utf-8">
	...
	<div class="element-textarea"  <?frmd1_add_class("textarea")?>><textarea class="medium" name="textarea" cols="20" rows="5" placeholder="PRAYER REQUEST" required="required"></textarea></div>
...
<form class="formoid-metro-orange" action="http://www.praisechurch.tv/forms/iwanttosharemystory_files/iwanttosharemystory.php" method="post" accept-charset="utf-8">
	...
	<div class="element-textarea"  <?frmd2_add_class("textarea")?>><textarea class="medium" name="textarea" cols="20" rows="5" placeholder="MY STORY" required="required"></textarea></div>
